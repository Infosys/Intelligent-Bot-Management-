...
{
    public class ContractSerializerCP : ContentProvider
    {
        Entities.Contract objectForContent;
        Entities.ContractModule objectModule;
        public ContractSerializerCP(Entities.Contract contractObject,
        ...
        internal class ForLoopCP : ContentProvider
        {
            ...
            internal static System.Collections.Hashtable ModelObjectModuleMapping = new System.Collections.Hashtable();
            ...
            string ModelObjectDataEntityNameSpace
            {
                get
                {
                    return ((Entities.Module)ModelObjectModuleMapping[objectForContent.ModelObjectEntity.ProgramId]).DataEntityNamespace;
                }
            }
            ...
            string ModelObjectSerializerNameSpace
            {
                get
                {
                    return ((Entities.Module)ModelObjectModuleMapping[objectForContent.ModelObjectEntity.ProgramId]).SerializerNamespace;
                }
            }
        ...
        //////        get
        //////        {
        //////            return ((Entities.Module)ForLoopCP.ModelObjectModuleMapping[objectForContent.Name.Substring(0, 4)]).DataEntityNamespace;
        //////        }
        //////    }
        ...
        internal class CaseStatementContentProvider : ContentProvider
        {
            ...
            string ModelObjectSerializerNS
            {
                get
                {
                    return ((Entities.Module)ForLoopCP.ModelObjectModuleMapping[objectForChildContent.Name.Substring(0, 4)]).SerializerNamespace;
                }
            }
            [PlaceHolder("ModelObjectDataEntityNS")]
            string ModelObjectDataEntityNS
            {
                get
                {
                    ...
                    return Framework.Helper.BuildNamespace(((Entities.Module)ForLoopCP.ModelObjectModuleMapping[objectForChildContent.Name.Substring(0, 4)]).DataEntityNamespace, objectForContent);
                }
            }
