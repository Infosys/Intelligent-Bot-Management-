...
{
    #region CobolModelObjectDataEntityCP definition
    /// <summary>
    /// Objects of this type are used to generate content for the 
    /// XSD for a Data Entity.
    /// </summary>
    class CobolModelObjectDataEntityCP : ContentProvider
    {    
        /// <summary>
        /// The entity for which the XSD is being gnerated.
        /// </summary>
        private Entities.Entity entityToBeUsed;
        ...
        /// </param>
        public CobolModelObjectDataEntityCP(Entities.ModelObjectModule modelObjectModule, Entities.Entity entityToBeBuilt)
        {
        ...
        private string BuildDataItems(Entities.GenericCollection<DataItem> genericCollection)
        {
                    ...
                    itemLooper++)
            {
                ...
                if (currItem.IsVisible)
                {
                    ...
                    else if (currItem.ItemType == DataItem.DataItemType.Enum && currItem.Length > 0)
                    {
    ...
    internal class DataItemEnumType : ContentProvider
    {
        ...
        Entities.DataItem enumItem;
        Entities.EnumType enumObject;
        internal Template DataItemPropertyTemplate;

        internal DataItemEnumType(Entities.DataItem enumTypeItem, Entities.EnumType enumDefinitionObject)
        {
    ...
    internal class DataItemContent : ContentProvider
    {
        ...
        string _name = " ";
        Entities.DataItem.DataItemType _type;
        public DataItemContent(Entities.DataItem itemToBeProvided)
        {
