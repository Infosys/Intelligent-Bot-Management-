...
#
#======================================================================================
#FILE : <CheckHighLoadSQLStatements.sh>
#USAGE : sh CheckHighLoadSQLStatements.sh [param1] [param2] [param3] [param4] [param5]
#Eg: sh CheckHighLoadSQLStatements.sh dbusername=orauser dbpassword=orapasswd1 ip=ip-10-177-120-76.ec2.internal port=1521 serviceid=XE executiontime=500000
#DESCRIPTION  : This script is used to establish Oracle DB Connection and check number of  
#               SQL Statements which are executing on High Load
...
select 'Metric Value=' as MetricValue, count(*) as NoOfHighLoadQuery from (SELECT SQL_ID||','||PLSQL_EXEC_TIME FROM $sql where PLSQL_EXEC_TIME>$executiontime);
EXIT;
EOF`
#======================================================================================
