...
#
# ======================================================================================
# FILE : <ReportExcessiveParsing.sh>
# USAGE : sh ReportExcessiveParsing.sh [param1] [param2] [param3] [param4] [param5]
# Eg: sh ReportExcessiveParsing.sh dbusername=orauser dbpassword=***** ip=ip-10-177-120-76.ec2.internal port=1521 serviceid=XE
# DESCRIPTION  : This script is used to display SQL queries experiencing excessive parsing.
