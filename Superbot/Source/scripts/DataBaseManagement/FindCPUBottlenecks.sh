...
#======================================================================================
#
#FILE : <FindCPUBottlenecks.sh>
#USAGE : sh FindCPUBottlenecks.sh 
#EXAMPLE: VALUES : sh FindCPUBottlenecks.sh 
...
r=`nproc`
echo "status=success"
echo "Metric Name=CPU Bottlenecks"
if [[ $val -gt $r ]]; then
