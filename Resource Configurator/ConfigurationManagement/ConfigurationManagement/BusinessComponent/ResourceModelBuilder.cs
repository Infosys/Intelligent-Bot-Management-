    ...
    public class ResourceModelBuilder
    {
        ...
        public bool UpdateCategoryandScriptId(BE.CategoryAndScriptDetails obj)
        {
            ...
            try
            {
                ...
                //var categoryList = ServiceCaller("http://" + obj.SEEBaseUrl + "/" + obj.CategoryServiceName);
                //var categoryList = ServiceCaller("http://vmgfpdstp-04/WEMScriptExecutor_Superbot/WEMScriptService.svc/GetAllScriptDetails/187");
